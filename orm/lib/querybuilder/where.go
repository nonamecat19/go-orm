...
func (qb *QueryBuilder) Where(condition string, args ...interface{}) *QueryBuilder {
	qb.where = qb.adapter.Where(condition, qb.where, args...)
...
func (qb *QueryBuilder) AndWhere(condition string, args ...interface{}) *QueryBuilder {
	qb.where = qb.adapter.AndWhere(condition, qb.where, args...)
	qb.args = append(qb.args, args...)
	return qb
}
...
func (qb *QueryBuilder) OrWhere(condition string, args ...interface{}) *QueryBuilder {
	qb.where = qb.adapter.OrWhere(condition, qb.where, args...)
	qb.args = append(qb.args, args...)
	return qb
}
